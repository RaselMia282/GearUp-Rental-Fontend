      ...
      <div className="relative z-20 max-w-7xl w-full mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <p className="text-gray-200 text-base md:text-lg max-w-xl font-medium leading-relaxed drop-shadow">
            Professional-grade outdoor gear delivered to your trailhead. Stop
            buying, start exploring with our curated inventory of rugged
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link
              href="/gears"
              className="bg-[#ff5522] hover:bg-[#e0481b] text-white font-semibold px-7 py-3.5 rounded-lg transition-all duration-200 cursor-pointer shadow-lg shadow-orange-950/30 inline-block text-center"
            >
              Explore Catalog
            </Link>
            ...
            <Link
              href="/how-it-works"
              className="bg-black/30 hover:bg-black/50 border border-white/40 text-white font-semibold px-7 py-3.5 rounded-lg backdrop-blur-md transition-all duration-200 cursor-pointer inline-block text-center"
            >
              How it Works
            </Link>
          </div>
